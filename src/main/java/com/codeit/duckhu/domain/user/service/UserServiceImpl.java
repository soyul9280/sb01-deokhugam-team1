...
public class UserServiceImpl implements UserService {
    ...
    public UserDto login(UserLoginRequest userLoginRequest) {
        ...
        User user = userRepository.findByEmail(email).orElseThrow(() -> new InvalidLoginException(ErrorCode.LOGIN_INPUT_INVALID));
    ...
    public UserDto findById(UUID id) {
        User user = userRepository.findById(id).orElseThrow(() -> new NotFoundUserException(ErrorCode.NOT_FOUND_USER));
        if (user.isDeleted()) {
